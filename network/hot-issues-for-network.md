...
其实是因为早期服务器资源有限，一个服务器往往要承担多项任务，所以在主域名前面加子域名`www`表示万维网服务[<sup>[16]</sup>](#refer-anchor-12)，例如`www.example.com`表示互联网，`mail.example.com`表示互联网服务。
